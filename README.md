...
To get started with the JuaConnect Frontend, follow these steps:
...
4. Start the development server:
   ...
   npm run dev
   ```
5. Open your browser and go to  to view the application.
...
- **ArtisanDashboard.jsx**: Main dashboard overview
