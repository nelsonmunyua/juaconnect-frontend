...
const api = {
  ...
  register: async (userData) => {
    ...
    try {
      ...
      const payload = {
        ...
        role: userData.user_type || userData.role,
      };
  ...
  acceptRequest: async (requestId) => {
    const response = await fetch(
      `${API_BASE_URL}/artisan/requests/${requestId}/accept`,
      {
        method: "POST",
        headers: {
          Authorization: `Bearer ${getToken()}`,
  ...
  startWork: async (requestId, totalAmount) => {
    const response = await fetch(
      `${API_BASE_URL}/artisan/requests/${requestId}/start`,
      {
        method: "POST",
        headers: {
          Authorization: `Bearer ${getToken()}`,
  ...
  completeWork: async (requestId) => {
    const response = await fetch(
      `${API_BASE_URL}/artisan/requests/${requestId}/complete`,
      {
        method: "POST",
        headers: {
          Authorization: `Bearer ${getToken()}`,
  ...
  searchArtisans: async (serviceCategory, location) => {
    ...
    const response = await fetch(
      `${API_BASE_URL}/artisan/search?${params.toString()}`,
    );
    return await response.json();
  },
